        ...
        <section className="calendar-section">
          ...
          {isExpanded ? (
            <div className="weekly-calendar-card">
              <div className="weekly-scroll-indicator">
              ...
              <div className="weekly-wrapper">
                ...
                <div className="weekly-body">
                  <div className="time-column">
                    <div className="time-slot">01</div>
                    <div className="time-slot">02</div>
                    <div className="time-slot">03</div>
                    <div className="time-slot">04</div>
                    <div className="time-slot">05</div>
                    <div className="time-slot">06</div>
                  </div>
                  <div className="grid-content">
                    {Array.from({ length: 6 }).map((_, rowIndex) => (
                      Array.from({ length: 6 }).map((_, colIndex) => {
                        let event = null;
                        if (rowIndex === 1 && colIndex === 1) event = "aniv..";
                        if (rowIndex === 1 && colIndex === 5) event = "pro..";
                        if (rowIndex === 3 && colIndex === 4) event = "fest..";
                  ...
                  <div className="weekly-scrollbar">
